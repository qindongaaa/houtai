<template>
    <div class="page1">
        ...
        <el-tabs type="card" @tab-click="routerTo">
          <el-tab-pane label="活动信息" val="1"></el-tab-pane>
          <el-tab-pane label="报名签到" val="1"></el-tab-pane>
          <el-tab-pane label="分享设置" val="1"></el-tab-pane>
          <el-tab-pane label="个性化设置" val="1"></el-tab-pane>
        </el-tabs>
  ...
  export default {
    ...
    methods: {
      routerTo: function (val) {
        this.$router.push('/active/activeManage/detail/page1/step'+(val.index+1));
      },
